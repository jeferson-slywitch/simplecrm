...
public class PesquisaCidade extends javax.swing.JInternalFrame {
    ...
    public void SetCidade(CadastroCidade Cidd){
            this.Cid = Cidd;
    }
    ...
    private void CarregaCidade(){
        ...
        SQL = "select codigo, nome from t_cidade ";
        SQL = SQL + "where UPPER(nome) like '%" + jtfPesquisa.getText().toUpperCase() + "%' and exclusao = 0 ";
