 ...
 */
public class PesquisaChave extends javax.swing.JInternalFrame {
    
    private ConexaoPostgresql Conexao;
    private CadastroChave Cc;

    /** Creates new form PesquisaChave */
    public PesquisaChave() {
        initComponents();
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Cc.CarregaDados(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaChave().setVisible(true);
            }
        });
    }
    ...
    public void SetChave(CadastroChave Chave){
        this.Cc = Chave;
    }
    ...
    private void CarregaEstado(){
        ...
        SQL = "select codigo, nome from t_chave where UPPER(nome) like '%" + jtfPesquisa.getText().toUpperCase() + "%' and exclusao = 0";
