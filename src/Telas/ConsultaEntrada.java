 ...
 * @author Estoque
 */
public class ConsultaEntrada extends javax.swing.JInternalFrame {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaEntrada().setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "DANFE", "Data DANFE", "Data Sistema", "Fornecedor"
            }
        ) {
    ...
    private void jtfCodigoFornecedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfCodigoFornecedorKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_F12){
            ...
            try{
                A.setSelected(true);
                A.SetSubConsultaEntrada(this);
                A.Validador("ConsultaEntrada");
            }catch (Exception E){
    ...
    private void Opcao (){
     ...
     public void CarregarDados(){
        ...
        String SQL;
        String myDate = null;
        String Codigo, Danfe, DataDanfe, DataSistema, CodFornecedor, NomeFornecedor, Obs;

        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        myDate = sdf.format(jdcDataDanfe.getDate());  
        
        SQL = "select te.codigo, te.danfe, to_char(te.data_danfe,'DD/MM/YYYY') as datadanfe, to_char(te.data_sistema,'DD/MM/YYYY') as datasistema, ";
        ...
        if (jrbFornecedor.isSelected()){
            SQL = SQL + "and te.fornecedor_cod = " + jtfCodigoFornecedor.getText() + " ";
        }
        ...
        try{
            while (RS.next()){
                ...
                Object[] CarLinha = {Codigo,Danfe,DataDanfe,DataSistema,NomeFornecedor};
    ...
    private void CarregarDadosItem(String Codigo){
        ...
        SQL = "select tei.codigo, tei.entrada_cod, tei.produto_cod, (tpr.nome) as produto, tei.qtde, tei.valor ";
        SQL = SQL + "from t_entrada_item tei ";
        SQL = SQL + "inner join t_produto tpr on tpr.codigo = tei.produto_cod ";
        SQL = SQL + "where tei.exclusao = 0 ";
        SQL = SQL + "and tei.entrada_cod = " + Codigo + " ";        
    ...
    private void CarregarDadosObs(String Codigo){
        ...
        String SQL = "select obs from t_entrada where codigo = " + Codigo + " ";
