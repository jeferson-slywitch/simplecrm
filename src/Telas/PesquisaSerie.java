 ...
 * @author Jeff
 */
public class PesquisaSerie extends javax.swing.JInternalFrame {

    private ConexaoPostgresql Conexao;
    private CadastroSerieMotorola CSM;
    private TextDocument TD;
    
    String Meleca;

    /** Creates new form AgendaPesquisa */
    public PesquisaSerie() { 
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Cadastro de Série Motorola Pesquisa");
    ...
    private void jtbPesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbPesquisaMouseClicked
        ...
        if (Meleca.equals("Serie")){
            CSM.CarregarDados(jtbPesquisa.getValueAt(jtbPesquisa.getSelectedRow(), 0).toString());
        }
    ...
    private void jtfPesquisaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfPesquisaKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            SQL = "select ts.codigo, (tpr.nome) as produto, ts.serie from t_serie ts ";
            SQL = SQL + "inner join t_produto tpr on tpr.codigo = ts.produto_cod ";
            SQL = SQL + "where UPPER(ts.serie) like '%" + jtfPesquisa.getText().toUpperCase() + "%' ";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaSerie().setVisible(true);
            }
        });
    }
    ...
    private void Visualizar(String SQL){
      ...
      try{
        ...
        while(RS.next()){
            ...
            Object[] Linha = {RS.getString("codigo"), RS.getString("produto"), RS.getString("serie")};
            Tabela.addRow(Linha);
        }
    ...
    public void SetCidade(CadastroSerieMotorola CadSM){
        this.CSM = CadSM;
    }
