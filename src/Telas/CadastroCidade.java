...
public class CadastroCidade extends javax.swing.JInternalFrame {
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        ...
        String Codigo;
        String EstadoCode = String.valueOf(((Combo)cboEstado.getSelectedItem()).getKey());
        
        Fun = new Funcoes();
        Codigo = Fun.Proximo("codigo", "t_cidade", "");
        ...
        Conexao.Conectar();
        Conexao.setSQL("select * from t_cidade where codigo = '" + jtfCodigo.getText() + "' and exclusao = 0");
        ResultSet RS = Conexao.Consultar();

        try {
            if(RS.next()){
                String SQL;
                SQL = "update t_cidade set nome = '" + jtfNome.getText() + "', estado_cod = '" + EstadoCode + "' where codigo = '" + jtfCodigo.getText() + "'";
                Conexao.setSQL(SQL);
                Conexao.Executar();
            } else {
                String SQL;                
                SQL = "insert into t_cidade (codigo, estado_cod, nome, exclusao) values(" + jtfCodigo.getText() + ", " + EstadoCode + ", '" + jtfNome.getText() + "', 0)";
                Conexao.setSQL(SQL);
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if(resposta == JOptionPane.YES_OPTION){
            ...
            String SQL = "update t_cidade set exclusao = 1 where codigo = '" + jtfCodigo.getText() + "'";
    ...
    public void CarregaDados(int Codigo){
        ...
        SQL = "select cid.codigo, cid.nome, cid.estado_cod, (tes.nome) as estado ";
        SQL = SQL + "from t_cidade cid ";
        SQL = SQL + "inner join t_estado tes on tes.codigo = cid.estado_cod ";
        SQL = SQL + "where cid.codigo = " + Codigo + " ";
        ...
        try{
            if (RS.next()){
                ...
                Combo Mot = new Combo(Integer.parseInt(RS.getString("estado_cod")), RS.getString("estado"));
                ComboBoxModel CBM;
    ...
    private void JogarEstados(){
        ...
        try {
            ...
            SQL = "select codigo, nome from t_estado ";
            ...
            while(RS.next()){
                Combo CB = new Combo(Integer.parseInt(RS.getString("codigo")),RS.getString("nome"));
