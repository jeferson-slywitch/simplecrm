 ...
 * @author Jeff
 */
public class PesquisaPais extends javax.swing.JInternalFrame {

    private ConexaoPostgresql Conexao;
    private CadastroPais Pa;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Pa.CarregaDados(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaPais().setVisible(true);
            }
        });
    }
    ...
    public void SetPais(CadastroPais Pais){
        this.Pa = Pais;
    }
    ...
    private void CarregaEstado(){
        ...
        SQL = "select codigo, nome from t_pais where UPPER(nome) like '%" + jtfPesquisa.getText().toUpperCase() + "%' and exclusao = 0";
