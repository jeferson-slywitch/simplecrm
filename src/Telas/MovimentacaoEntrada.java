 ...
 * @author Tecsuport
 */
public class MovimentacaoEntrada extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Movimentação de Entrada");
        setToolTipText("");
    ...
    private void jbtPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtPesquisarActionPerformed
        ...
        PesquisaEntrada A = new PesquisaEntrada();
        A.setVisible(true);
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if (!(jtfCodigo.getText().trim().equals(""))) {
            ...
            if(resposta == JOptionPane.YES_OPTION){
                ...
                SQL = "update t_entrada set exclusao = 1 where codigo = " + jtfCodigo.getText() + " ";
                ...
                while(contador <= linha_total){
                    ...
                    SQL2 = "update t_entrada_item set ";
                    SQL2 = SQL2 + "exclusao = 1 ";
                    SQL2 = SQL2 + "where codigo = " + Ordem + " ";
                    SQL2 = SQL2 + "and entrada_cod = " + EntradaCod + " ";
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        ...
        Conexao = new ConexaoPostgresql();
        Conexao.Conectar();
        Conexao.setSQL("select * from t_entrada where codigo = " + jtfCodigo.getText() + " and exclusao = 0 ");
        ...
        try {
            if(RS.next()){
                ...
                SQL = "update t_entrada set fornecedor_cod = " + jtfCodigoFornecedor.getText() + ", ";
...
//                    NomeProduto = jTable1.getValueAt(linha, 2).toString();
                    ...
                    if (Status.equals("UPD")){
                        ...
                        SQL2 = "insert into t_entrada_item (entrada_cod, produto_cod, qtde, valor, exclusao) ";
                        SQL2 = SQL2 + "values (";
                ...
                SQL = "insert into t_entrada (danfe, data_danfe, data_sistema, fornecedor_cod, obs, senha, exclusao) ";
                SQL = SQL + "values ('" + jtfDanfe.getText() + "', '" + myDateDanfe + "', '" + myDateSistema + "', ";
                SQL = SQL + jtfCodigoFornecedor.getText() + ", '" + jtpObs.getText() + "', '" + Senha + "', 0)";
...
//                    NomeProduto = jTable1.getValueAt(linha, 2).toString();
    ...
    private void jtfCodigoProdutoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfCodigoProdutoKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_F12){
            ...
            try{
                A.setSelected(true);
                A.SetSubProdutoEntrada(this);
                A.Validador("ProdutoMovimentacao");
            }catch (Exception E){
                JOptionPane.showMessageDialog(null, "Erro: " + E);
            }
            A.setVisible(true);
...
//        }        
    ...
    private String BuscaCodigoSenha (String password){
        ...
        SQL = "select codigo from t_entrada where senha = '" + password + "' and exclusao = 0 ";
    ...
    private void LimpaSenha (String Codigo){
        ...
        SQL = "update t_entrada set senha = null where codigo = " + Codigo + " and exclusao = 0 ";
    ...
    public void CarregarDados(String Codigo){
        ...
        SQL = "select te.codigo, te.danfe, to_char(te.data_danfe,'DD/MM/YYYY') as datadanfe, ";
        SQL = SQL + "to_char(te.data_sistema,'DD/MM/YYYY') as datasistema, ";
        SQL = SQL + "te.fornecedor_cod, (tp.nome) as fornecedor, te.obs ";
        SQL = SQL + "from t_entrada te ";
        SQL = SQL + "inner join t_pessoa tp on tp.codigo = te.fornecedor_cod ";
        SQL = SQL + "where te.codigo = " + Codigo + " ";
        SQL = SQL + "and te.exclusao = 0 ";
        ...
        SQL2 = "select tei.codigo, tei.entrada_cod, tei.produto_cod, (tpr.nome) as produto, tei.qtde, tei.valor ";
        SQL2 = SQL2 + "from t_entrada_item tei ";
        SQL2 = SQL2 + "inner join t_produto tpr on tpr.codigo = tei.produto_cod ";
        SQL2 = SQL2 + "where tei.entrada_cod = " + Codigo + " ";
        SQL2 = SQL2 + "and tei.exclusao = 0 ";
