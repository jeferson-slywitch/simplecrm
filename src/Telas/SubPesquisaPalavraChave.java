 ...
 */
public class SubPesquisaPalavraChave extends javax.swing.JInternalFrame {
    ...
    public SubPesquisaPalavraChave() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Procura Palavra Chave");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (Meleca.equals("AberturaChamado")){
            MCA.PalavraChaveViaF12(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubPesquisaPalavraChave().setVisible(true);
            }
        });
    }
    ...
    private void CarregaCidade(){
        ...
        SQL = "select tc.codigo, tc.nome from t_chave tc ";
        SQL = SQL + "where UPPER(tc.nome) like '%" + jtfPesquisa.getText().toUpperCase() + "%' ";
        SQL = SQL + "and tc.exclusao = 0 ";
        SQL = SQL + "order by tc.codigo ";
